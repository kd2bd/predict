...
#ifdef DEBUG
  fprintf(stderr,"ICR10: trying to open rig with config: %s.\n",config);
  fprintf(stderr,"ICR10: config tty: %s\n",tty);
  fprintf(stderr,"ICR10: config speed: %s\n",speed);
  fprintf(stderr,"ICR10: config CI-V address: %s\n",civid);
#endif
